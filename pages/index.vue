  ...
  <div id="recruit">
    ...
    <section id="intro">
      ...
      <ul>
        <li>
          <h3>RAY 是什麼？</h3>
          <p>行政院國家發展委員會一直戮力推動政府網站數位服務改善，PDIS 透過教育部青年發展署的大專生公部門實習計畫，開辦青年學生體檢政府網站數位服務專案（RAY - Rescue Action by Youth .gov），邀請青年和國發會及相關部會協作，一同改善政府網站數位服務體驗。本見習計畫自 2017 年起至今已經舉辦 4 屆，今年將招募第 5 屆。</p>
        </li>
        <li>
          <h3>要做些什麼？</h3>
        ...
        <li>
          <h3>我們怎麼做？</h3>
        <p>RAY 5.0 將透過教育部青年發展署「大專生公部門見習計畫」招募 20 名具有使用者經驗、服務設計和網頁系統開發相關背景的大專院校在學學生，與機關同仁一起改造政府網站的數位服務體驗。除了原則上兩週一次的實體見面協作外，本見習大多數時間為小組自行安排，同學可透過線上討論或組內自行約定實體見面工作，PDIS也會架設 IM 平台讓大家線上即時討論協作。</p>
        </li>
        <li>
          <h3>結束以後？</h3>
    ...
    <section id="faq">
      ...
      <div class="wrapper">
        <h3>我不是大學生，也可以報名嗎？</h3>
        <p>這次的見習機會來自教育部青年發展署的「大專生公部門見習計畫」，所以僅限於大專院校的大學生和研究生參與（8月底、9月初的成果發表會當日，仍需具備在校生身份），我們仍然歡迎你持續提供對於政府網站的所有意見。</p>
        <h3>我要具備什麼條件才能報名呢？</h3>
        <p>希望是具有使用者研究（User reserach )、服務設計（Service Design）、使用者介面（UI/User Interface）、使用者體驗（UX/User Experience）、網頁系統開發（Web Development）以上任一專長或相關科系之學生，惟具網頁系統開發（Web Development）專長之同學須對於使用者介面或體驗設計（UI/UX）敏感度佳且有興趣。</p>
        ...
        <h3>遠距見習要怎麼計算工時？</h3>
        <p>我們會請你依照檢查結果填寫檢查報告，並以此為依據計算工時，詳細內容會在報到時說明。</p>
        <h3>我可以從這次見習中學到什麼？</h3>
