  ...
  <div id="recruit">
    ...
    <section id="intro">
      ...
      <ul>
        <li>
          <h3>RAY 是什麼？</h3>
          <p>行政院國家發展委員會一直戮力推動政府網站數位服務改善，PDIS 透過教育部青年發展署的大專生公部門實習計畫，開辦青年學生體檢政府網站數位服務專案（RAY - Rescue Action by Youth .gov），邀請青年和國發會及相關部會協作，一同改善政府網站數為服務體驗。自 2017 年起至今已經舉辦 4 屆，今年將招募第 5 屆 </p>
        </li>
        <li>
          <h3>要做些什麼？</h3>
          <p>RAY 將和行政院國家發展委員會的「政府網站導入使用者中心設計（User Centeral Design）輔導工作坊（UCD工作坊）」合作，參與改善今年度輔導之機關的網站數位服務體驗。透過網站使用者研究，經由訪談、分析、討論、激盪發想等過程，最終產出網站改善建議提供部會參考。</p>
        </li>
        <li>
          <h3>我們怎麼做？</h3>
        <p>RAY 5.0 將透過教育部青年發展署「大專生公部門見習計畫」招募 20 名青年在學學生。我們將招募具有使用者經驗、服務設計和網頁系統開發相關背景的同學們與機關同仁一起改造政府網站的數位服務體驗。除了原則上兩週一次的實體見面協作外，本見習大多數時間為小組自行安排，同學可透過線上討論或組內自行約定實體見面工作。PDIS也會架設 IM 平台讓大家線上即時討論協作。</p>
        </li>
        <li>
          <h3>結束以後？</h3>
          <p>RAY 的見習成果將會提供網站主管機關，作為未來進行網站改版的參考依據，並全數上網公開，供社會大眾參考</p>
        </li>
      </ul>
    ...
    <section id="faq">
      ...
      <div class="wrapper">
        <h3>我不是大學生，也可以報名嗎？</h3>
        <p>這次的見習機會來自教育部青年發展署的「大專生公部門見習計畫」，所以僅限於大專院校的大學生和研究生參與（8月底、9月初的成果發表會當日，仍需具備在校生身份），我們仍然歡迎你持續提供任何對於政府網站的意見。</p>
        <h3>我要具備什麼條件才能報名呢？</h3>
        <p>希望是具有使用者研究（User reserach )、服務設計（Service Design）、使用者介面（UI/User Interface）、使用者體驗（UX/User Experience）、網頁系統開發（Web Development）以上任一專長或相關科系之學生，惟網頁系統開發（Web Development）專長之同學須對於使用者介面或體驗設計（UI/UX）敏感度佳且有興趣的同學參加。</p>
        <p>報名時請附上作品集或任何可以線上展示專案之連結，例如包括（但不限於）Behance、Figma、Skecth Resource、Dribbble、GitHub/GitLab Repository、個人網站</p>
        <h3>為什麼會找見習生來體檢政府網站數位服務？</h3>
        <p>政府網站應提供一致且友善的使用體驗，透過教育部青年署的「大專生公部門見習計畫」，希望邀請青年朋友一同協作，讓政府數位服務更為完善，並藉此強化政府與青年朋友的互動。</p>
        <h3>我要到行政院上班嗎？</h3>
        <p>不用，我們主要以線上協作進行，原則上每兩周舉辦一次小型實體聚會，見習結束後舉行成果發表會。</p>
        <h3>我要怎麼和 PDIS 的人工作？</h3>
        <p>無論何時何地，你都可以透過線上平台討論、共筆處理報告文件。我們也會架設專屬的 IM 軟體提供線上提問、討論，所有互動紀錄都可以查詢。</p>
        <h3>遠距見習要怎麼計算工時？</h3>
        <p>我們會請你依照檢查結果填寫檢查報告，並以此為依據計算工時，詳細流程會在報到時說明。</p>
        <h3>我可以從這次見習中學到什麼？</h3>
        <p>透過體檢政府網站數位服務，你可以深入瞭解政府機關的業務內容、廣泛了解數位服務。過程中除了可以學習與他人線上協作，也可以從中獲得豐富的 UI/UX 設計和開發原型軟體的經驗。</p>
        <h3>以後還有類似的見習機會嗎？</h3>
    ...
    <section id="comment" class="container">
      ...
      />
      <div class="intro">
        <p>來自不同大專院校的同學們各懷專長，在兩個月的協作中磨合與推進，透過「遠距工作」、「設計與資訊背景協作」、「部會人員共同參與」等作法加乘，淬煉出不同的工作模式和心法。歡迎了解同學們的見習心得，更深入地瞭解他們如何做好準備，並投入此次專案。</p>
      </div>
      <div class="filter">
...
#title > .wrapper {
  ...
  grid-template-areas: "header" "video" "footer";
  gap: 1rem;
...
#recruit > section:nth-child(2n) > h2:after {
  background-color: var(--color-ray);
}
...
#comment {
  ...
  padding-right: min(7.5em, 8.33vw);
}
